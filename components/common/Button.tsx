...
const StyledButton = tw.button`flex gap-3 items-center justify-center bg-primary-700 h-full w-full px-4 py-2.5 dark:text-gray-50 text-gray-50 rounded-lg hover:opacity-80`;
