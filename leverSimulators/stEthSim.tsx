...
export const stEthSimulator: Simulator = async (
  ...
  if (input.big.gt(ZERO_BN) && provider) {
    ...
    const totalToInvest: W3bNumber = inputAsFyToken.big.gt(ZERO_BN)
      ? convertToW3bNumber(totalToInvest_, 18, 3)
      : ZERO_W3N;

    const toBorrow_ = totalToInvest.big.sub(inputAsFyToken.big);
    const toBorrow: W3bNumber = inputAsFyToken ? convertToW3bNumber(toBorrow_, 18, 3) : ZERO_W3N;
    ...
    if (inputAsFyToken.big.gt(ZERO_BN)) {
      ...
      output.debtAtMaturity = convertToW3bNumber(debt_, 18, 3);
      ...
      output.shortInvested = convertToW3bNumber(wethObtained, 18, 3);
      output.investmentFee = convertToW3bNumber(output.shortInvested.big.mul(4).div(10000), 18, 3);
      ...
      output.investmentLong = convertToW3bNumber(boughtStEth, 18, 3);
